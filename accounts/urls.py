...
from accounts.views import RegisterView, LoginUserView, ResetPassword, CustomPasswordResetConfirmView, EditProfileView
...
urlpatterns = [
    ...
    path('user-profile/<int:pk>', EditProfileView.as_view(), name='user-profile'),
